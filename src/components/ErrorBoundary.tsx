      ...
      return (
        <div className="bg-background flex min-h-screen items-center justify-center p-4">
          <div className="w-full max-w-md rounded-xl border border-red-100 bg-white p-8 text-center shadow-xl">
            ...
            <h1 className="text-main text-2xl font-black">Something went wrong</h1>
            ...
            <button
              ...
              className="bg-primary hover:bg-primary/90 mt-6 flex w-full items-center justify-center gap-2 rounded-lg px-6 py-3 font-bold text-white transition active:scale-95"
            >
              <RefreshCcw size={18} />
              Reload Application
            </button>
